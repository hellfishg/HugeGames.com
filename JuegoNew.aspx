...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row">
        <asp:Repeater ID="rpJuego" runat="server">
            <ItemTemplate>
                <div class="col-md-9">
                ...
                <div class="col-md-3">
                    <div class="card mt-5">
                        ...
                        <div class="card-footer">
                            <asp:LinkButton runat="server" CssClass="btn btn-primary btn-sm pull-right"><i class="fa fa-shopping-cart"></i></asp:LinkButton>
